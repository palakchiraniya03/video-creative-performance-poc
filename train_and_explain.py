...
import shap
import matplotlib
matplotlib.use("Agg")  # save-only backend, no interactive display
...
# ---- Visualizations: saved to outputs/ for inspection/debugging ----
os.makedirs("outputs", exist_ok=True)

# SHAP beeswarm summary plot: shows, across ALL test predictions, which
# features push predictions up/down and by how much -- this is the plot
# that visually confirms the "hook_type / brand_id near-zero importance"
# finding described in the README.
plt.figure()
...
# LightGBM native feature importance (split-count based) -- a second,
# independent view of feature relevance, useful to cross-check against
# the SHAP-based importance above.
...
print("\nSaved outputs/shap_summary.png and outputs/feature_importance.png")
